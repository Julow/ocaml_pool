...
(*   Updated: 2015/06/25 13:00:59 by jaguillo         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
class virtual atom __name __symbol __number = object
	...
	method equal (a:atom) = a#name = _name && a#symbol = _symbol && a#atomic_number = _atomic_number
end
...
let test a =
	...
	print_endline (string_of_bool (a#equal (new holmium)))
